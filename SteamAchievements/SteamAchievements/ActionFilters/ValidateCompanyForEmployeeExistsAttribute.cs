...
{
    public class ValidateCompanyForEmployeeExistsAttribute : IAsyncActionFilter
    {
        private readonly Contracts.IRepositoryManager _repository;
        private readonly Contracts.ILoggerManager _logger;
        public ValidateCompanyForEmployeeExistsAttribute(IRepositoryManager repository, ILoggerManager logger)
        {
